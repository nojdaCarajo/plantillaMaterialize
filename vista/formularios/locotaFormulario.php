...
<div class="fixed-action-btn" id="addLOCOTA" style="bottom: 10%; margin: 0%;">
...
<div class="col s12">
<div class="card oculto" id="locotaFormulario">
<div class="card-content">
<div class="right-align">
<i style="font-size: 22pt;" class="cerrarLOCOTA modal-close fas fa-times"></i>
</div>
<form id="locotaForm">
<span class="card-title">
<h3>Informacion de LOCOTA</h3>
</span>
...
<button type="button"  id="eliLOCOTA" class="btn red darken-1 oculto ">Eliminar <i class="fas fa-trash-alt"></i></button>

<button id="modLOCOTA" class="btn orange darken-1 oculto">Actualizar <i class="fas fa-pen"></i></button>

<button id="regLOCOTA" name="accion" value="registrar" class="btn green darken-1 oculto" >Guardar <i class="fas fa-save"></i></button>

<button class="cerrarLOCOTA  modal-close waves-effect waves-light btn-flat ">Cerrar <i class="fas fa-times"></i></button>
