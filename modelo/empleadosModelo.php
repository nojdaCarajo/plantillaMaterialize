...
class EmpleadosModel extends Conexion
{
	...
	public function listarEmpleadosModel()
	{
		$sql="SELECT * FROM";
	...
	public function registrarEmpleadosModel()
	{
		...
		public function modificarEmpleadosModel()
		{
			...
			public function borrarEmpleadosModel()
			{
