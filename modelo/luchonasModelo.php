...
class LuchonasModel extends Conexion
{
	...
	public function listarLuchonasModel()
	{
		$sql="SELECT * FROM";
	...
	public function registrarLuchonasModel()
	{
		...
		public function modificarLuchonasModel()
		{
			...
			public function borrarLuchonasModel()
			{
